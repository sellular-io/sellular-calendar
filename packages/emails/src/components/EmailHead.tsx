...
const EmailHead = ({ title = "" }) => {
  return (
    <head>
      ...
      />
      <RawHtml
        html={`<!--[if !mso]><!--><link href="https://fonts.googleapis.com/css?family=Poppins:400,500,700" rel="stylesheet" type="text/css"/>
      <style type="text/css">@import url(https://fonts.googleapis.com/css?family=Poppins:400,500,700);</style><!--<![endif]-->`}
      />
      <style type="text/css">
        {`
