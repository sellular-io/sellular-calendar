...
export const BaseScheduledEmail = (
  ...
  return (
    <BaseEmailHtml
      ...
      <Info label={t("rejection_reason")} description={props.calEvent.rejectionReason} />
      <Info label={t("what")} description={props.calEvent.title} />
      <WhenInfo timeFormat={timeFormat} calEvent={props.calEvent} t={t} timeZone={timeZone} locale={locale} />
      <WhoInfo calEvent={props.calEvent} t={t} />
      <LocationInfo calEvent={props.calEvent} t={t} />
      <Info label={t("description")} description={props.calEvent.description} formatted />
      <Info label={t("additional_notes")} description={props.calEvent.additionalNotes} />
