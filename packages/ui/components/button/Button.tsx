...
const buttonClasses = cva(
  "inline-flex items-center text-sm font-medium relative rounded-md transition-colors md:sellular-button",
  {
    variants: {
      variant: {
        button: "",
      ...
      color: {
        ...
        destructive: "",
        transparent:"text-sel-main-primary hover:bg-info md:!p-2",
      },
      size: {
    ...
    compoundVariants: [
      ...
      ...applyStyleToMultipleVariants({
        ...
        color: "primary",
        className:
          "bg-brand-default hover:sellular-primary-button-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset focus-visible:ring-brand-default text-brand font-semibold",
      }),
      {
        disabled: true,
        color: "primary",
      ...
      ...applyStyleToMultipleVariants({
        ...
        color: "secondary",
        className:
          "hover:bg-muted hover:border-emphasis focus-visible:bg-subtle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset focus-visible:ring-empthasis ",
      }),
      // Minimal variants
      {
        disabled: true,
      ...
      ...applyStyleToMultipleVariants({
        ...
        color: "minimal",
        className:
          "sellular-secondary-button hover:bg-subtle focus-visible:bg-subtle focus-visible:outline-none focus-visible:ring-offset focus-visible:ring-empthasis",
      }),
    ...
    <>
      {StartIcon && (
        <>
          {variant === "fab" ? (
            <>
              <StartIcon className="hidden h-4 w-4 stroke-[2.5px] ltr:mr-2 ltr:-ml-1 rtl:-mr-1 rtl:ml-2 md:inline-flex" />
            ...
            <StartIcon
              className={classNames(
                ...
                variant === "button" && "h-4 w-4 stroke-[2.5px] ltr:-ml-1 ltr:mr-2 rtl:-mr-1 rtl:ml-2"
              )}
            />
          )}
        </>
...
const Wrapper = ({ children, tooltip }: { tooltip?: string; children: React.ReactNode }) => {
  ...
  return <Tooltip content={tooltip} side="bottom">{children}</Tooltip>;
};
