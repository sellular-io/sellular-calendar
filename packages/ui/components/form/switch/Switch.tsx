    ...
    <Wrapper tooltip={props.tooltip}>
      <div
        ...
        <PrimitiveSwitch.Root
          className={cx(
            isChecked ? "bg-green" : "bg-disabled",
            primitiveProps.disabled && "cursor-not-allowed",
            "h-[14px] w-[34px] rounded-full shadow-none flex items-center",
            props.className
          )}
          {...primitiveProps}>
          <PrimitiveSwitch.Thumb
            id={id}
            className={cx(
              "block h-[20px] w-[20px] rounded-full transition will-change-transform ltr:translate-x-[0px] rtl:-translate-x-[4px] ltr:[&[data-state='checked']]:translate-x-[17px] rtl:[&[data-state='checked']]:-translate-x-[17px] sellular-switch-thumb",
