  ...
  return (
    <input
      ...
      className={classNames(
        "hover:border-emphasis dark:focus:border-emphasis border-default bg-default placeholder:text-muted text-emphasis disabled:hover:border-default disabled:bg-subtle mb-2 block h-9 border py-2 px-3 text-sm leading-4 focus:border-neutral-300 focus:outline-none focus-within:sellular-input-field-focus focus:sellular-input-field-focus disabled:cursor-not-allowed sellular-input-field focus:-focus",
        isFullWidth && "w-full",
        props.className
      )}
    />
...
const Addon = ({ isFilled, children, className, error }: AddonProps) => (
  <div
    className={classNames(
      "addon-wrapper border-default [input:hover_+_&]:border-emphasis [input:hover_+_&]:border-l-default [&:has(+_input:hover)]:border-emphasis [&:has(+_input:hover)]:border-r-default h-9 border px-3 sellular-input-field-addon [&:has(+_input:focus)]:sellular-input-field-addon-focus [input:focus_+_&]:sellular-input-field-addon-left-focus p-0",
      isFilled && "bg-subtle",
      className
    )}>
    <div
  ...
  return (
    <div className={classNames(containerClassName)}>
      ...
      {addOnLeading || addOnSuffix ? (
        <div
          dir="ltr"
          className="focus-within:ring-brand-default group relative mb-1 flex items-center focus-within:outline-none sellular-input-field focus-within:sellular-input-field-focus focus:sellular-input-field-focus">
          {addOnLeading && (
...
export const TextArea = forwardRef<HTMLTextAreaElement, TextAreaProps>(function TextAreaInput(props, ref) {
  return (
    <textarea
      ...
      {...props}
      className={classNames(
        "hover:border-emphasis border-default bg-default placeholder:text-muted text-emphasis disabled:hover:border-default disabled:bg-subtle mb-2 block w-full border py-2 px-3 text-sm focus:border-neutral-300 disabled:cursor-not-allowed focus:border-emphasis",
        props.className
      )}
    />
  );
