  ...
  ({ children, sideOffset = 2, align = "end", ...props }, forwardedRef) => {
    return (
      <DropdownMenuPrimitive.Content
        ...
        className={classNames(
          "shadow-dropdown w-50 bg-default border-subtle relative z-10 ml-1.5 origin-top-right border text-sm",
...
export const DropdownItem = (props: DropdownItemProps) => {
  ...
  return (
    <ButtonOrLink
      {...rest}
      className={classNames(
        "hover:text-emphasis text-default inline-flex w-full items-center space-x-2 px-4 py-3  disabled:cursor-not-allowed disabled:opacity-70",
