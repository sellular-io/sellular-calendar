  ...
  return (
    <ReactSelect
      ...
      classNames={{
        ...
        control: (state) =>
          cx(
            "bg-default border-default !min-h-[36px] h-[36px] text-sm leading-4 placeholder:text-sm placeholder:font-normal dark:focus:border-emphasis focus-within:outline-none focus-within:sellular-input-field-focus focus-within:ring-brand-default hover:border-emphasis border",
            state.isMulti
              ? variant === "checkbox"
                ? "px-3 py-2 h-fit"
                : state.hasValue
        ...
        multiValue: () =>
          cx(
            "bg-normal text-default py-1.5 px-2 flex items-center text-xs leading-none",
            props.classNames?.multiValue
          ),
        menu: () =>
          cx(
            "bg-default text-sm leading-4 text-default mt-1 sellular-select border-subtle py-2",
            props.classNames?.menu
          ),
        groupHeading: () => "leading-none text-xs text-default pl-2.5 pt-4 pb-2 font-semibold",
        menuList: () => cx("scroll-bar scrollbar-track-w-20", props.classNames?.menuList),
