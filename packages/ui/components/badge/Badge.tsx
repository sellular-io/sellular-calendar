...
const badgeStyles = cva("font-medium inline-flex items-center justify-center gap-x-1", {
  variants: {
    variant: {
      ...
      green: "bg-success text-green",
      gray: "bg-normal text-default",
      blue: "bg-info text-sel-main-primary",
