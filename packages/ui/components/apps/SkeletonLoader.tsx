...
export function SkeletonLoader({
  ...
  return (
    <>
      <ShellSubHeading title={<div className="bg-subtle h-6 w-32 mx-4" />} {...{ className }} />
      {title && description && <Meta title={title} description={description} />}

      <ul className="bg-default border-subtle divide-subtle -mx-4 animate-pulse divide-y border sm:mx-0 sm:overflow-hidden">
        <SkeletonItem />
        <SkeletonItem />
        <SkeletonItem />
      </ul>
