  ...
  return (
    <div>
      <div>
        ...
        <ul className="border-default divide-subtle mt-2 divide-y border">
              ...
              <li
                ...
                <div>
                  <div className="flex flex-col lg:flex-row lg:items-center">
                    <div className="text-emphasis text-sm font-semibold ltr:mr-2 rtl:ml-2">
                ...
                {field.editable !== "user-readonly" && !disabled && (
                  <div className="flex items-center space-x-2">
                    ...
                    <Button
                      ...
                      color="secondary"
                      className="text-sel-main-primary hover:bg-info !p-2"
                      onClick={() => {
      ...
      <Dialog
        ...
        <DialogContent className="max-h-none p-0" data-testid="edit-field-dialog">
          <div className="h-auto max-h-[85vh] overflow-auto px-[1px]">
          ...
          <DialogFooter className="relative rounded pb-4" showDivider>
