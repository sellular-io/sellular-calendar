...
const DateOverrideList = ({
  ...
  return (
    <ul className="border-subtle border" data-testid="date-overrides-list">
      {items.sort(sortByDate).map((item, index) => (
        <li key={item.id} className="border-subtle flex justify-between border-b p-4 last:border-b-0">
          <div>
