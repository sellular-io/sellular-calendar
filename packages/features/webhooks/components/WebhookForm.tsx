    ...
    <>
      <Form
        ...
        <Controller
          ...
          control={formMethods.control}
          render={({ field: { value } }) => (
            <div className="font-sm text-emphasis mt-4 font-medium">
              <Switch
        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => {
            ...
            return (
              <div className="mt-4">
                <Label className="font-sm text-emphasis mt-4 font-medium">
                  <>{t("event_triggers")}</>
                </Label>
                <Select
        ...
        <Controller
          ...
          render={({ field: { value } }) => (
            <>
              <Label className="font-sm text-emphasis mt-4">
                <>{t("payload_template")}</>
              </Label>
              <div className="mb-2">
                <ToggleGroup
        ...
        />
        <div className="bg-subtle mt-4 p-4">
          <WebhookTestDisclosure />
        </div>

        <div className="mt-4 flex place-content-end space-x-4">
          <Button
            type="button"
            color="minimal"
