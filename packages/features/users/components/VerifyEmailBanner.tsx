...
function VerifyEmailBanner() {
  ...
  const { isSelSettings, isSellular, isSelConfSettings } = router?.query
  ...
  if (data?.isVerified || !flags["email-verification"] || isSellularSettings || isSellularCalendar || isSellularConfSettings) return null;
