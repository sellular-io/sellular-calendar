...
export const defaultLocations: DefaultEventLocationType[] = [
  {
    ...
    variable: "address",
    organizerInputType: null,
    messageForOrganizer: "Sellular will ask your invitee to enter an address before scheduling.",
  ...
  },
  {
    ...
    messageForOrganizer: "Sellular will ask your invitee to enter a phone number before scheduling.",
...
export const getMessageForOrganizer = (location: string, t: TFunction) => {
  ...
  if (videoLocation && videoLocation.linkType !== "static" && videoLocation.type !== "integrations:zoom") {
    return t(`Sellular will provide a ${videoLocation.label} URL.`);
  }
  return "";
};
