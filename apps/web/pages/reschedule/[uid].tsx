...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  const { uid: bookingId } = z
    ...
    .parse(context.query);
  const isSellularCalendar = context.query?.isSellular === 'true'
  const isLinkFromSellularCal = context.query?.isLinkFromSellular === "true"
  ...
  destinationUrl.set("isSellular", "true")
  }
  if (isLinkFromSellularCal) {
    destinationUrl.set("isLinkFromSellular", "true")
  }
