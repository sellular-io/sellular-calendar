...
const DateOverride = ({ workingHours }: { workingHours: WorkingHours[] }) => {
  ...
  return (
    <div className="p-4">
      <h3 className="text-emphasis font-medium leading-6 font-semibold">
        {t("date_overrides")}{" "}
      ...
      <div className="space-y-2">
        ...
        <DateOverrideInputDialog
          ...
          Trigger={
            <Button color="transparent" StartIcon={Plus} data-testid="add-override">
              {t("add_an_override")}
            </Button>
          }
        />
...
export default function Availability() {
  ...
  const { fromEventType ,isSellular} = router.query;
  ...
  const deleteMutation = trpc.viewer.availability.schedule.delete.useMutation({
    ...
    onSuccess: () => {
      ...
      router.push(`/availability${isSellularCalendar? `?isSellular=true` : ''}`);
    },
  });

  return (
    <Shell
      backPath={fromEventType ? true :`/availability${isSellularCalendar? `?isSellular=true` : ''}`}
      ...
      CTA={
        <div className="flex items-center justify-end">
          <div className="sm:hover:bg-muted hidden items-center px-2 sm:flex">
            <Skeleton as={Label} htmlFor="hiddenSwitch" className="mt-2 cursor-pointer self-center pr-2 font-normal text-sm text-emphasis ">
              {t("set_to_default")}
            </Skeleton>
            <Switch
              id="hiddenSwitch"
      ...
      <div className="mt-4 w-full md:mt-0">
        <Form
          ...
          className="flex flex-col sm:mx-0 xl:flex-row">
          <div className="flex-1 flex-row xl:mr-0">
            <div className="border-subtle border mx-4">
              <div>
            ...
            <div className="border-subtle m-4 border">
              {schedule?.workingHours && <DateOverride workingHours={schedule.workingHours} />}
            </div>
          </div>
          <div className="min-w-40 col-span-3 space-y-2 lg:col-span-1">
            <div className="xl:max-w-80 w-full pr-4 sm:ml-0 sm:mr-4 sm:p-0">
              <div>
                <label htmlFor="timeZone" className="text-default block text-sm font-medium font-semibold">
                  {t("timezone")}
                </label>
                <Controller
                  name="timeZone"
                  render={({ field: { onChange, value } }) =>
                    value ? (
                      <TimezoneSelect
                        value={value}
                        className="focus:border-brand-default border-default mt-1 block w-72 text-sm"
              ...
              <div className="hidden mt-3 md:block">
                ...
                <div className="mt-1 flex">
                  <Button href="/availability/troubleshoot" color="transparent">
