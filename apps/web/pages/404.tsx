...
return (
  <div style ={{display:'flex', alignItems:'center', justifyContent:'center', height:'100vh', flexDirection:'column'}}>
    <img
    src={`${WEBAPP_URL}/sellular/404.png`}
    srcSet={`${WEBAPP_URL}/sellular/404.svg`}
    style={{
      height: "300px",
      width: "100%",
      marginLeft: "0.5rem",
    ...
    alt=""
  />
  <div style={{width:'500px',textAlign:'center',color:'#606060'}}>Sorry but this page does not exist, please check if the url is correct, page is removed or renamed!</div>
  </div>
)
  if (isInsights) {
    return (
