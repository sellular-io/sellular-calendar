  ...
  let bookedActions: ActionType[] = [
    {
      ...
      }${booking.seatsReferences.length ? `&seatReferenceUid=${getSeatReferenceUid()}` : ""}${isSellularCalendar? `&isSellular=true` : ''}
      `,
      icon: X,
    },
    {
      ...
      actions: [
        {
          ...
          }${isSellularCalendar? booking.seatsReferences.length ? `&isSellular=true` : `?isSellular=true` : ''}`,
        },
        {
  ...
  const onClickTableData = () => {
    router.push({
      ...
      query: {
        ...
        isSellular: isSellularCalendar ? 'true' :  '',
      },
    });
  };
