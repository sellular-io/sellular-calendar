  ...
  const mutation = useMutation(createBooking, {
    onSuccess: async (responseData) => {
      ...
      const query = {
        ...
        isSellular : isSellularCalendar ? true : undefined,
        isLinkFromSellular: isLinkFromSellularCal ? true : undefined,
        email: bookingForm.getValues("responses.email"),
  ...
  const bookEvent = (bookingValues: BookingFormValues) => {
    ...
    if (recurringDates.length) {
      ...
      const recurringBookings = recurringDates.map((recurringDate) => ({
        ...
        hasHashedBookingLink,
        hashedLink,
        isLinkFromSellularCal: isLinkFromSellularCal ? true : undefined,
      }));
