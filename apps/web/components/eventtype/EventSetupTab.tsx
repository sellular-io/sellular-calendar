          ...
          <ul ref={animationRef}>
            {validLocations.map((location, index) => {
              ...
              return (
                <li
                  ...
                  className="border-default text-default mb-2 h-9 border py-1.5 px-2 hover:cursor-pointer">
              ...
              <div className="text-default flex text-sm">
                ...
                <Trans i18nKey="event_type_requres_google_cal">
                  <p>
                    ...
                    Change it{" "}
                    <Link
                      href={`${WEBAPP_URL}/event-types/${eventType.id}?tabName=advanced${isSellularCalendar? `&isSellular=true` : ''}`}
                      className="underline">
                      here.
                    </Link>{" "}
                  </p>
            ...
            {isChildrenManagedEventType && !locationAvailable && locationDetails && (
              <p className="pl-1 text-sm leading-none text-red-600">
                ...
                <a className="underline" href={`${WEBAPP_URL}/apps/${locationDetails.slug}${isSellularCalendar? `?isSellular=true` : ''}`}>
                  {t("connect_now")}
                </a>
              </p>
            )}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                noOptionsMessage={() =><div className="h-9 p-3 flex justify-start items-center"> {t("default_duration_no_options")}</div>}
