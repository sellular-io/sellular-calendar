...
export const EditLocationDialog = (props: ISetLocationDialog) => {
  ...
  const LocationOptions = (() => {
    if (eventLocationType && eventLocationType.organizerInputType && LocationInput) {
      ...
      return (
        <div>
          <label htmlFor="locationInput" className="text-default block text-sm font-medium my-2">
      ...
      return <p className="text-default text-sm pt-3">{getMessageForOrganizer(selectedLocation, t)}</p>;
    }
  })();
